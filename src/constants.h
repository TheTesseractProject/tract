...
#define BAD_ARGUMENT ERROR_MSG "'" COLOR_RED "%s" COLOR_RESET "'" COLOR_RESET " is not a recognized argument. See '-h' for help.\n"
#define FILE_NOT_EXIST ERROR_MSG "File '" COLOR_RED "%s" COLOR_RESET "' does not exist.\n"
#define INVALID_EXTENSION ERROR_MSG "File '" COLOR_RED "%s" COLOR_RESET "' does not have a valid extension (.t, .tes, or .tt).\n"
#define BUILD_FILE_NOT_SPECIFIED ERROR_MSG "Build file not specified.\n"
...
#define HELP_TEXT "\n" COLOR_BRIGHT_WHITE "About" COLOR_RESET "\n" TRACT " is bla bla bla bla...\n\n" COLOR_BRIGHT_WHITE "Available options" COLOR_RESET "\n-v, --version: Show version\n-h, --help: Show help text\n-b, --build: Build the program (or you can just specify the path to the file without arguments)\n\n" COLOR_BRIGHT_WHITE "Usage" COLOR_RESET "\n" COLOR_GRAY "tract <args> <path>" COLOR_RESET "\n\n"
